    ...
    case gender = "female":
        switch (day) {
            ...
            case (2 || -2):
                ...
                break;
            case (3 || -3):
                document.getElementById("result").innerHTML = "The day is on a wednesday." + "Your Akan name" + femaleNames[3];
                break;
            case (4 || -4):
                document.getElementById("result").innerHTML = "The day is on a thursday." + "Your Akan name" + femaleNames[4];
                break;
            case (5 || -5):
                document.getElementById("result").innerHTML = "The day is on a friday." + "Your Akan name" + femaleNames[5];
                break;
            case (6 || -6):
                document.getElementById("result").innerHTML = "The day is on a saturday." + "Your Akan name" + female[6];
                break;
